...
router.post("/chat", async (req, res) => {
  ...
  try {
    // ✅ One-shot prompting: give Gemini a single example before the real query
    const oneShotExample = `
You are DateLore AI. Given a date, return a JSON with a historical event.

Example:
User: "07-20"
AI: { "date": "July 20", "event": "On July 20, 1969, Neil Armstrong became the first human to walk on the Moon." }

Now respond to this new query:
User: "${formattedDate}"
    `;
